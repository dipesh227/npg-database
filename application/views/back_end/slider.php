                                            ...
                                            <form role="form" class="mb-4 border p-4" id="slideriminsert">
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label for="sliderpic1">File input</label>
                                                        <div class="input-group">
                                                            <div class="custom-file">
                                                                <input type="file" class="custom-file-input" id="sliderpic1" name='sliderpic1' accept="image/*">
                                                                <label class="custom-file-label" for="sliderpic1" id='sliderpic12'>Choose file</label>
                                                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form method="post" id="edit_form">
                                ...
                                <div class="form-group">
                                    <label for="edit_email">Choose Slider Image</label>
                                    <div class="input-group">
                                        <div class="custom-file">
...
<script>
    $(document).ready(function() {
        ...
        function fetchdata() {
            $.ajax({
                url: "<?php echo base_url(); ?>admin/fetchme",
                type: "post",
                dataType: "json",
                success: function(data) {
                    if (data.responce == "success") {
                            ...
                            "columns": [{
...

                                {
                                    ...
                                    "render": function(data, type, row, meta) {
                                        var a = `
                                        <img class="rounded" style="height: 100px; width:auto" id="" src="data:image/jpg;base64,${row.sliderpic}" alt="pics">
                                    `;
                                        return a;
    ...
    $('#sliderpic1').change(function() {
        $('#sliderpic12').text($('#sliderpic1').val().split('\\').pop())
    });
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.responce == "success") {
                    ...
                    $('#preview_pic').attr("src", 'data:image/jpg;base64,' + data.post.sliderpic + '');
