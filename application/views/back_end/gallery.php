                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-xl" role="document">
                                        <div class="modal-content">
                                            ...
                                            <!-- form start -->
                                            <form role="form" class="mb-4 border p-4" id="slideriminsert">
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label for="gallerypic">File input</label>
                                                        <div class="input-group">
                                                            <div class="custom-file">
                                                                <input type="file" class="custom-file-input" id="gallerypic" name='gallerypic' accept="image/*">
                                                                <label class="custom-file-label" for="gallerypic" id='sliderpic12'>Choose file</label>
                                                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form method="post" id="edit_form">
                                ...
                                <div class="form-group">
                                    <label for="edit_email">Choose gallery Image</label>
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" name="edit_email" id="edit_email">
                                            <label class="custom-file-label" for="edit_email">Select Image</label>
                                        </div>
                                    </div>
                                </div>
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<script>
    $(document).ready(function() {
        ...
        $("#slideriminsert").submit(function() {
            ...
            if (image == "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() ?>admin/galleryimginsert",
        ...
        function fetchdata() {
            $.ajax({
                url: "<?php echo base_url(); ?>admin/fetchgalleryimg",
                type: "post",
                dataType: "json",
                success: function(data) {
                    if (data.responce == "success") {
                            ...
                            "columns": [{
...

                                {
                                    ...
                                    "render": function(data, type, row, meta) {
                                        var a = `
                                        <img class="rounded" style="height: 100px; width:auto" id="" src="data:image/jpg;base64,${row.pic}" alt="pics">
                                    `;
                                        return a;
                                    }
                                },
    ...
    $('#gallerypic').change(function() {
        $('#sliderpic12').text($('#gallerypic').val().split('\\').pop())
    });
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.responce == "success") {
                    ...
                    $('#preview_pic').attr("src", 'data:image/jpg;base64,' + data.post.pic + '');
